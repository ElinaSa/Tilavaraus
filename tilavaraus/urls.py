...
from . import views
from .views import home, login, logout, reservations, booking_list, booking_detail, testi, create_booking, new_reservation, edit_booking, delete_booking, SpaceListAPI, BookingListAPI, BookingDetailAPI, TestAPIView
